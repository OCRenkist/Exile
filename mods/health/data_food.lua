...
food_harm_table = {
	...
	["nodes_nature:tangkal_fruit"]   = { { "Food Poisoning",      0.001, 1},
	                                     { "Drunk",               0.005, 1} },
	--meat
	["animals:carcass_invert_small"] = { { "Food Poisoning",      0.10,  1},
	                                     { "Intestinal Parasites", 0.01,  1} },
	["animals:carcass_invert_large"] = { { "Food Poisoning",      0.20,  1},
	...
	["animals:carcass_fish_small"]   = { { "Food Poisoning",      0.05,  1},
	                                     { "Intestinal Parasites", 0.02,  1} },
	["animals:carcass_fish_large"]   = { { "Food Poisoning",      0.10,  1},

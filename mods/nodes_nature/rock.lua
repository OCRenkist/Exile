	...
	minetest.register_node("nodes_nature:"..name, {
		...
		minetest.register_node("nodes_nature:"..name.."_block", {
			...
			node_box = {
				type  = "fixed",
				fixed = {
					{-0.375, -0.500, -0.375,  0.375, 0.500,  0.375},
					{-0.375, -0.500,  0.375,  0.375, 0.500,  0.500},
					{-0.375, -0.500, -0.500,  0.375, 0.500, -0.375},
					{ 0.375, -0.500, -0.375,  0.500, 0.500,  0.375},
					{-0.500, -0.500, -0.375, -0.375, 0.500,  0.375},
					{-0.500, -0.375, -0.500, -0.375, 0.375, -0.375},
					{ 0.375, -0.375, -0.500,  0.500, 0.375, -0.375},
					{ 0.375, -0.375,  0.375,  0.500, 0.375,  0.500},
					{-0.500, -0.375,  0.375, -0.375, 0.375,  0.500},
				}
			}, ]]

...
minetest.register_node("tech:crushed_lime", {
	...
	--(realistically should be 900, but too hard for fires)
...
minetest.register_node('tech:loose_brick_unfired', {
	...
	node_box     = {
		type  = "fixed",
		fixed = {
			{ 0.0625, -0.50, -0.5000,  0.5000, -0.25, -0.2500}, -- NodeBox11
			{-0.5000, -0.50, -0.5000, -0.0625, -0.25, -0.2500}, -- NodeBox12
			{-0.5000, -0.50, -0.1250, -0.0625, -0.25,  0.1250}, -- NodeBox13
			{-0.5000, -0.50,  0.2500, -0.0625, -0.25,  0.5000}, -- NodeBox14
			{ 0.0625, -0.50, -0.1250,  0.5000, -0.25,  0.1250}, -- NodeBox15
			{ 0.0625, -0.50,  0.2500,  0.5000, -0.25,  0.5000}, -- NodeBox16
			{ 0.1875, -0.25, -0.5000,  0.4375,  0.00,  0.0000}, -- NodeBox22
			{ 0.2500, -0.25,  0.0000,  0.5000,  0.00,  0.5000}, -- NodeBox23
			{-0.4375, -0.25, -0.5000, -0.1875,  0.00,  0.0000}, -- NodeBox24
			{-0.3750, -0.25,  0.0000, -0.1250,  0.00,  0.5000}, -- NodeBox25
			{-0.1250, -0.25, -0.1875,  0.1250,  0.00,  0.3125}, -- NodeBox26
			{ 0.0625,  0.00, -0.4375,  0.5000,  0.25, -0.1875}, -- NodeBox27
			{ 0.0625,  0.00, -0.1250,  0.5000,  0.25,  0.1250}, -- NodeBox28
			{ 0.0000,  0.00,  0.2500,  0.4375,  0.25,  0.5000}, -- NodeBox29
			{-0.4375,  0.00,  0.1875,  0.0000,  0.25,  0.4375}, -- NodeBox30
			{-0.5000,  0.00, -0.1250, -0.0625,  0.25,  0.1250}, -- NodeBox31
			{-0.5000,  0.00, -0.4375, -0.0625,  0.25, -0.1875}, -- NodeBox32
			{-0.3750,  0.25,  0.0000, -0.1250,  0.50,  0.5000}, -- NodeBox33
			{-0.5000,  0.25, -0.5000, -0.2500,  0.50,  0.0000}, -- NodeBox34
			{-0.1250,  0.25, -0.5000,  0.1250,  0.50,  0.0000}, -- NodeBox35
			{ 0.1875,  0.25, -0.5000,  0.4375,  0.50,  0.0000}, -- NodeBox36
			{ 0.2500,  0.25,  0.0000,  0.5000,  0.50,  0.5000}, -- NodeBox37
			{-0.0625,  0.25,  0.0000,  0.1875,  0.50,  0.5000}, -- NodeBox38
		}
	},
...
minetest.register_node('tech:loose_brick', {
	...
	node_box    = {
		...
		fixed = {
			...
			{-0.5000,  0.00, -0.1250, -0.0625,  0.25,  0.1250}, -- NodeBox31
			{-0.5000,  0.00, -0.4375, -0.0625,  0.25, -0.1875}, -- NodeBox32
			{-0.3750,  0.25,  0.0000, -0.1250,  0.5,   0.5000}, -- NodeBox33
			{-0.5000,  0.25, -0.5000, -0.2500,  0.5,   0.0000}, -- NodeBox34
			{-0.1250,  0.25, -0.5000,  0.1250,  0.5,   0.0000}, -- NodeBox35
			{ 0.1875,  0.25, -0.5000,  0.4375,  0.5,   0.0000}, -- NodeBox36
			{ 0.2500,  0.25,  0.0000,  0.5000,  0.5,   0.5000}, -- NodeBox37
			{-0.0625,  0.25,  0.0000,  0.1875,  0.5,   0.5000}, -- NodeBox38
		}
	},
...
minetest.register_node("tech:roof_tile_loose_unfired", {
	...
	node_box    = {
		type  = "fixed",
		fixed = {
			{-0.5000, -0.500, -0.5000, -0.2500, -0.375, -0.0625}, -- NodeBox1
			{-0.5000, -0.500,  0.0625, -0.2500, -0.375,  0.5000}, -- NodeBox2
			{-0.1250, -0.500, -0.5000,  0.1250, -0.375, -0.0625}, -- NodeBox3
			{ 0.2500, -0.500, -0.5000,  0.5000, -0.375, -0.0625}, -- NodeBox4
			{-0.1250, -0.500,  0.0625,  0.1250, -0.375,  0.5000}, -- NodeBox5
			{ 0.2500, -0.500,  0.0625,  0.5000, -0.375,  0.5000}, -- NodeBox6
			{-0.5000, -0.375,  0.2500, -0.0625, -0.250,  0.5000}, -- NodeBox7
			{-0.5000, -0.375, -0.0625, -0.0625, -0.250,  0.1875}, -- NodeBox8
			{-0.5000, -0.375, -0.4375, -0.0625, -0.250, -0.1875}, -- NodeBox9
			{ 0.0000, -0.375, -0.4375,  0.4375, -0.250, -0.1875}, -- NodeBox10
			{ 0.0625, -0.375, -0.1250,  0.5000, -0.250,  0.1250}, -- NodeBox11
			{ 0.0625, -0.375,  0.1875,  0.5000, -0.250,  0.4375}, -- NodeBox12
			{-0.4375, -0.250, -0.5000, -0.1875, -0.125, -0.0625}, -- NodeBox13
			{-0.1250, -0.250, -0.4375,  0.1250, -0.125,  0.0000}, -- NodeBox14
			{ 0.2500, -0.250, -0.5000,  0.5000, -0.125, -0.0625}, -- NodeBox15
			{ 0.1875, -0.250,  0.0625,  0.4375, -0.125,  0.5000}, -- NodeBox16
			{-0.1250, -0.250,  0.0625,  0.1250, -0.125,  0.5000}, -- NodeBox17
			{-0.5000, -0.250,  0.0625, -0.2500, -0.125,  0.5000}, -- NodeBox18
			{ 0.0000, -0.125, -0.4375,  0.4375,  0.000, -0.1875}, -- NodeBox19
			{-0.5000, -0.125, -0.5000, -0.0625,  0.000, -0.2500}, -- NodeBox20
			{-0.5000, -0.125, -0.1250, -0.0625,  0.000,  0.1250}, -- NodeBox21
			{-0.5000, -0.125,  0.2500, -0.0625,  0.000,  0.5000}, -- NodeBox22
			{ 0.0625, -0.125,  0.2500,  0.5000,  0.000,  0.5000}, -- NodeBox23
			{ 0.0625, -0.125, -0.1250,  0.5000,  0.000,  0.1250}, -- NodeBox24
			{-0.4375,  0.000,  0.0625, -0.1875,  0.125,  0.5000}, -- NodeBox28
			{-0.0625,  0.000,  0.0625,  0.1875,  0.125,  0.5000}, -- NodeBox29
			{ 0.2500,  0.000,  0.0625,  0.5000,  0.125,  0.5000}, -- NodeBox30
			{ 0.1875,  0.000, -0.5000,  0.4375,  0.125, -0.0625}, -- NodeBox31
			{-0.1250,  0.000, -0.4375,  0.1250,  0.125,  0.0000}, -- NodeBox32
			{-0.5000,  0.000, -0.4375, -0.2500,  0.125,  0.0000}, -- NodeBox33
			{ 0.0625,  0.125, -0.1250,  0.5000,  0.250,  0.1250}, -- NodeBox34
			{ 0.0625,  0.125,  0.1875,  0.5000,  0.250,  0.4375}, -- NodeBox35
			{ 0.0625,  0.125, -0.5000,  0.5000,  0.250, -0.2500}, -- NodeBox36
			{-0.5000,  0.125, -0.5000, -0.0625,  0.250, -0.2500}, -- NodeBox37
			{-0.5000,  0.125, -0.1250, -0.0625,  0.250,  0.1250}, -- NodeBox38
			{-0.4375,  0.125,  0.2500,  0.0000,  0.250,  0.5000}, -- NodeBox39
			{-0.4375,  0.250, -0.5000, -0.1875,  0.375, -0.0625}, -- NodeBox40
			{-0.0625,  0.250, -0.4375,  0.1875,  0.375,  0.0000}, -- NodeBox41
			{ 0.2500,  0.250, -0.4375,  0.5000,  0.375,  0.0000}, -- NodeBox42
			{ 0.1875,  0.250,  0.0625,  0.4375,  0.375,  0.5000}, -- NodeBox43
			{-0.1250,  0.250,  0.0625,  0.1250,  0.375,  0.5000}, -- NodeBox44
			{-0.5000,  0.250,  0.0000, -0.2500,  0.375,  0.4375}, -- NodeBox45
			{-0.4375,  0.375, -0.4375,  0.0000,  0.500, -0.1875}, -- NodeBox46
			{ 0.0625,  0.375, -0.4375,  0.5000,  0.500, -0.1875}, -- NodeBox47
			{ 0.0625,  0.375, -0.1250,  0.5000,  0.500,  0.1250}, -- NodeBox48
			{ 0.0625,  0.375,  0.1875,  0.5000,  0.500,  0.4375}, -- NodeBox49
			{-0.4375,  0.375,  0.1875,  0.0000,  0.500,  0.4375}, -- NodeBox50
			{-0.4375,  0.375, -0.1250,  0.0000,  0.500,  0.1250}, -- NodeBox51
		}
	},
	groups = {oddly_breakable_by_hand = 3, falling_node = 1, heatable =15},
	sounds = nodes_nature.node_sound_stone_defaults(),
...
minetest.register_node("tech:roof_tile", {
	...
	node_box    = {
		type  = "fixed",
		fixed = {
			{-0.50,  0.2500,  0.1250, -0.25,  0.5000,  0.5000}, -- s1
			{-0.50,  0.0000, -0.0625, -0.25,  0.2500,  0.3125}, -- s2
			{-0.50, -0.2500, -0.2500, -0.25,  0.0000,  0.1250}, -- s3
			{-0.50, -0.5000, -0.5000, -0.25, -0.2500, -0.1250}, -- s4
			{ 0.25,  0.2500,  0.1250,  0.50,  0.5000,  0.5000}, -- s5
			{ 0.25, -0.5000, -0.5000,  0.50, -0.2500, -0.1250}, -- s6
			{ 0.25,  0.0000, -0.0625,  0.50,  0.2500,  0.3125}, -- s7
			{ 0.25, -0.2500, -0.2500,  0.50,  0.0000,  0.1250}, -- s8
			{-0.25,  0.2500,  0.1250,  0.25,  0.4375,  0.5000}, -- NodeBox23
			{-0.25,  0.0000, -0.0625,  0.25,  0.1875,  0.3125}, -- NodeBox24
			{-0.25, -0.2500, -0.2500,  0.25, -0.0625,  0.1250}, -- NodeBox25
			{-0.25, -0.5000, -0.5000,  0.25, -0.3125, -0.1250}, -- NodeBox26
			{-0.25, -0.3125, -0.3125,  0.25, -0.2500, -0.1250}, -- NodeBox30
			{-0.25, -0.0625, -0.1250,  0.25,  0.0000,  0.1250}, -- NodeBox32
			{-0.25,  0.1875,  0.0625,  0.25,  0.2500,  0.3125}, -- NodeBox33
			{-0.25,  0.4375,  0.3125,  0.25,  0.5000,  0.5000}, -- NodeBox34
		}
	},
...
minetest.register_node("tech:roof_tile_oc", {
	...
	node_box    = {
		type  = "fixed",
		fixed = {
			{-0.50,  0.1875,  0.250, -0.250,  0.5000,  0.50}, -- s1
			{-0.25, -0.0625,  0.000,  0.000,  0.2500,  0.25}, -- NodeBox40
			{ 0.00, -0.3125, -0.250,  0.250,  0.0000,  0.00}, -- NodeBox41
			{ 0.25, -0.5000, -0.500,  0.500, -0.2500, -0.25}, -- NodeBox42
			{-0.50, -0.5000, -0.500,  0.250, -0.3125, -0.25}, -- NodeBox43
			{-0.50, -0.2500, -0.250,  0.000, -0.0625,  0.00}, -- NodeBox44
			{-0.50,  0.0000,  0.000, -0.250,  0.1875,  0.25}, -- NodeBox45
			{-0.25,  0.0000,  0.250,  0.000,  0.1875,  0.50}, -- NodeBox47
			{ 0.00, -0.2500,  0.000,  0.250, -0.0625,  0.50}, -- NodeBox48
			{ 0.25, -0.5000, -0.250,  0.500, -0.3125,  0.50}, -- NodeBox49
			{-0.50,  0.1875,  0.125, -0.250,  0.3125,  0.25}, -- NodeBox54
			{-0.25,  0.1875,  0.250, -0.125,  0.3125,  0.50}, -- NodeBox55
			{-0.50, -0.0625, -0.125,  0.000,  0.0625,  0.00}, -- NodeBox56
			{ 0.00, -0.0625,  0.000,  0.125,  0.0625,  0.50}, -- NodeBox57
			{ 0.25, -0.3125, -0.250,  0.375, -0.1875,  0.50}, -- NodeBox58
			{-0.50, -0.3125, -0.375,  0.250, -0.1875, -0.25}, -- NodeBox59
		}
	},
	groups      = {cracky = 3, oddly_breakable_by_hand = 1},
	sounds      = nodes_nature.node_sound_stone_defaults(),
...
minetest.register_node("tech:roof_tile_ic", {
	...
	node_box    = {
		type  = "fixed",
		fixed = {
			{-0.500,  0.1875,  0.2500, -0.2500,  0.5000,  0.500}, -- s1
			{-0.250, -0.0625,  0.0000,  0.0000,  0.2500,  0.250}, -- NodeBox40
			{ 0.000, -0.3125, -0.2500,  0.2500,  0.0000,  0.000}, -- NodeBox41
			{ 0.250, -0.5000, -0.5000,  0.5000, -0.2500, -0.250}, -- NodeBox42
			{-0.125, -0.3125, -0.5000,  0.2500, -0.1250, -0.250}, -- NodeBox60
			{-0.375, -0.0625, -0.5000,  0.0000,  0.1250,  0.000}, -- NodeBox61
			{-0.500,  0.1875, -0.5000, -0.2500,  0.3750,  0.250}, -- NodeBox62
			{-0.250,  0.1875,  0.2500,  0.5000,  0.3750,  0.500}, -- NodeBox63
			{ 0.000, -0.0625,  0.0000,  0.5000,  0.1250,  0.375}, -- NodeBox64
			{ 0.250, -0.3125, -0.2500,  0.5000, -0.1250,  0.125}, -- NodeBox65
			{-0.125, -0.1250, -0.5000,  0.0625, -0.0625, -0.250}, -- NodeBox66
			{-0.375,  0.1250, -0.5000, -0.1875,  0.1875,  0.000}, -- NodeBox67
			{-0.500,  0.3750, -0.5000, -0.3750,  0.5000,  0.250}, -- NodeBox68
			{-0.250,  0.3750,  0.3750,  0.5000,  0.5000,  0.500}, -- NodeBox69
			{ 0.000,  0.1250,  0.1875,  0.5000,  0.1875,  0.375}, -- NodeBox70
			{ 0.250, -0.1250, -0.0625,  0.5000, -0.0625,  0.125}, -- NodeBox71
		}
	},
	groups      = {cracky = 3, oddly_breakable_by_hand = 1},
	sounds      = nodes_nature.node_sound_stone_defaults(),

...
minetest.register_node("tech:stick", {
	...
	node_box = {
	type          = "connected",
	fixed         = {{-0.0625, -0.5000, -0.0625,  0.0625, 0.5000,  0.0625}},
	connect_front = {{-0.0625, -0.0625, -0.5000,  0.0625, 0.0625, -0.0625}},
	connect_left  = {{-0.5000, -0.0625, -0.0625, -0.0625, 0.0625,  0.0625}},

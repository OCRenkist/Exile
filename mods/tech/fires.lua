...
local function hearth_fire_on(pos)
	if math.random()<0.6 then
		...
		minetest.add_particlespawner({
			...
			minvel     = {x = 0.00,        y = 0,           z = 0.00       },
			maxvel     = {x = 0.01,        y = 0.07,        z = 0.01       },
			minacc     = {x = 0.00,        y = 0,           z = 0.00       },
	...
	minetest.add_particlespawner({
		...
		minvel     = {x = 0.000,       y = 0.000,       z = 0.000      },
		maxvel     = {x = 0.001,       y = 0.001,       z = 0.001      },
		minacc     = {x = 0.000,       y = 0.000,       z = 0.000      },
...
local function on_place_fert(itemstack, placer, pointed_thing)
	...
	if minetest.get_item_group(onnode.name, "attached_node") > 0 or
	   minetest.get_item_group(innode.name,  "attached_node") > 0 then
		return itemstack
	else

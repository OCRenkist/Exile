...
minetest.register_node("tech:wooden_floor_boards", {
	...
	node_box    = {
		type  = "fixed",
		fixed = {
			{-0.500, 0.25, -0.5,  0.500, 0.50, 0.50}, -- NodeBox1
			{-0.375, 0.00, -0.5, -0.125, 0.25, 0.50}, -- NodeBox2
			{ 0.125, 0.00, -0.5,  0.375, 0.25, 0.50}, -- NodeBox5
		}
	},
	tiles = {
...
minetest.register_node("tech:wooden_stairs", {
	...
	node_box    = {
		type  = "fixed",
		fixed = {
			{-0.5, -0.375, -0.5000, 0.5, -0.250, -0.25},
			{-0.5,  0.375,  0.2500, 0.5,  0.500,  0.50},
			{-0.5, -0.125, -0.2500, 0.5,  0.000,  0.00},
			{-0.5,  0.125,  0.0000, 0.5,  0.250,  0.25},
			{-0.5, -0.500, -0.4375, 0.5, -0.375, -0.25},
			{-0.5, -0.250, -0.1875, 0.5, -0.125,  0.00},
			{-0.5,  0.000,  0.0625, 0.5,  0.125,  0.25},
			{-0.5,  0.250,  0.3125, 0.5,  0.375,  0.50},
		}
	},
	stack_max  = minimal.stack_max_medium,
	paramtype  = "light",

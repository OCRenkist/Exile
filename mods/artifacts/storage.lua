...
minetest.register_node("artifacts:antiquorium_chest", {
	...
	tiles       = {
		"artifacts_antiquorium_chest_top.png",
	...
	node_box    = {
		type  = "fixed",
		fixed = {
			{-0.5000, -0.4375, -0.5000,  0.5000, -0.2500,  0.5000}, -- NodeBox1
			{-0.5000,  0.3750, -0.5000,  0.5000,  0.5000,  0.5000}, -- NodeBox2
			{-0.5000, -0.5000, -0.5000, -0.3125, -0.4375, -0.3125}, -- NodeBox3
			{-0.5000, -0.5000,  0.3125, -0.3125, -0.4375,  0.5000}, -- NodeBox4
			{ 0.3125, -0.5000,  0.3125,  0.5000, -0.4375,  0.5000}, -- NodeBox5
			{ 0.3125, -0.5000, -0.5000,  0.5000, -0.4375, -0.3125}, -- NodeBox6
			{-0.4375, -0.2500, -0.4375,  0.4375,  0.3750,  0.4375}, -- NodeBox7
		}
	},
	groups = {cracky = 1},

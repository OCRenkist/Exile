...
local S = minetest.get_translator("bones") -- Load support for MT game translation.
bones   = {}
...
minetest.register_node("bones:bones", {
	...
	on_punch = function(pos, node, player)
		...
		if has_space then -- remove bones if player emptied them
...
minetest.register_on_dieplayer(function(player)
	...
	if bones_mode == "keep" or 
		(creative and creative.is_enabled_for and creative.is_enabled_for(player:get_player_name())) then
			minetest.log("action", 
				player_name .. 
				" dies at " .. 
				pos_string  ..
